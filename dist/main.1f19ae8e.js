...
var div1 = dom.create("<div>新增一个子节点</div>");
var div2 = dom.create("<div>插入一个节点</div>"); // const div = dom.create("<td>123</td>");

console.log(div);
dom.after(test, div);
dom.before(test, div);
dom.append(test, div1);
dom.wrap(div1, div2); // dom.remove(div1);
// dom.remove(empty);

dom.empty(empty); // 写入

dom.attr(test, "title", "I am title!"); // 读取
